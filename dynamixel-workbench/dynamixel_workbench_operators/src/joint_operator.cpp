...
#include <dynamixel_workbench_operators/multi.h>
int main(int argc, char **argv)
{
  ros::init(argc, argv, "joint_operator");

  dynamixel_workbench_operators::multi joint_command;
  ros::NodeHandle node_handle;

  ros::ServiceClient joint_command_client =
                node_handle.serviceClient<dynamixel_workbench_operators::multi>("joint_command");
...
*/
joint_command.request.a = 512;
joint_command.request.b = 512;
joint_command.request.c = 512;
joint_command.request.d = 512;
joint_command.request.e = 512;
